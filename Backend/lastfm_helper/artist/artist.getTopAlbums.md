...
| ------------------ | ---------------------------------- |
| **Method**         | GET                                |
| **Endpoint**       | `/2.0/?method=artist.gettopalbums` |
...
- **XML**: `/2.0/?method=artist.gettopalbums&artist=cher&api_key=YOUR_API_KEY`
...
- `artist.getTags` (previous)
- `artist.getTopTags` (next)
